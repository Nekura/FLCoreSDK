...
namespace DALib
{
	EXTERN  struct IAlchemy *  Alchemy;
	EXTERN  struct IAnimation2 *  Anim;
	EXTERN  struct IChannel *  Channel;
	EXTERN  void __cdecl CloseData(void);
	EXTERN  struct ICOManager *  Dacom;
	EXTERN  struct IFileSystem *  Data;
	EXTERN  struct IDeformable *  Deform;
	EXTERN  struct IEngine2 *  Engine2;
	EXTERN  struct IEngine *  Engine;
	EXTERN  struct IFxEffectLibrary *  FxEffectLibrary;
	EXTERN  struct IFxRuntime *  FxRuntime;
	EXTERN  struct IHardpoint *  Hardpoint;
	EXTERN  struct IMatAnimLibrary *  MatAnimLibrary;
	EXTERN  struct IMaterialBatcher2 *  MaterialBatcher;
	EXTERN  struct IMaterialLibrary *  MaterialLib;
	EXTERN  void __cdecl OpenData(char const *);
	EXTERN  struct IRenderPipeline *  Pipeline;
	EXTERN  struct IRPDraw *  RPDraw;
	EXTERN  struct IRPIndexBuffer *  RPIndexBuffer;
	EXTERN  struct IRPVertexBuffer *  RPVertexBuffer;
	EXTERN  struct IRenderer2 *  Renderer;
	EXTERN  void __cdecl Shutdown(struct HWND__ *);
	EXTERN  struct ISoundManager *  Sound;
	EXTERN  bool __cdecl Startup(struct HWND__ *,char const *);
	EXTERN  struct IStreamer2 *  Streamer;
	EXTERN  struct ITextureLibrary2 *  TextureLib;
	EXTERN  struct IVMeshLibrary *  VMeshLibrary;
	EXTERN  struct IVertexBufferManager *  VertexBuffer;
};

class EXTERN IDPMsgHandler
{
public:
...
EXTERN  bool (__cdecl* CriticalWarningFn)(unsigned int,char const *);
EXTERN  void (__cdecl* FatalErrorFn)(unsigned int,char const *);
