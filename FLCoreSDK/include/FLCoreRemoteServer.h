...
//--------------------------
//
//	File:			FLCoreRemoteServer.h
//	Module:			FLCoreRemoteServer.lib
//	Description:	Interface to RemoteServer.dll
//
//	Web: www.skif.be/flcoresdk.php
//  
//
//////////////////////////////////////////////////////////////////////
#ifndef _FLCOREREMOTESERVER_H_
#define _FLCOREREMOTESERVER_H_

#include "FLCoreDefs.h"
#include <list>

#pragma comment( lib, "FLCoreRemoteServer.lib" )
